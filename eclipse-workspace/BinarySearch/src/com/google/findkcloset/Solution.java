...
public class Solution {
	...
	// 162. Find Peak Element Microsoft & Google. Please note the following solution
	// could also be used
	// to this question. But note, index vs value.
	// 585. Maximum Number in Mountain Sequence LintCode
	// Given a mountain sequence of n integers which increase first and then
	// decrease, find the top.
	...
	public double myPow(double x, int n) {
		...
		/*
		 * O(n) will exceed time limit. for (long i = 0; i < N; i++) ans = ans * x;
		 */
		return ans;
	}
